...
const LightRays = ({
    ...
    const initializeWebGL = async () => {
      ...
      const updatePlacement = () => {
        ...
        const { anchor, dir } = getAnchorAndDir(
          raysOrigin,
          containerRef.current.clientWidth * dpr,
          containerRef.current.clientHeight * dpr
        );
  ...
  return (
    <div
      ref={containerRef}
      className={`w-full h-full pointer-events-none z-[0] overflow-hidden relative ${className}`}
    />
  );
};
