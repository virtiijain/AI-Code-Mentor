  ...
  <div className="relative min-h-screen w-full overflow-hidden bg-[#0F0F0F]">
    ...
    <div className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 py-6 w-full min-h-screen">
      <header className="text-center max-w-xl sm:max-w-2xl px-2 relative z-10 mb-8">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#57595B] via-slate-400 to-[#D3DAD9] leading-snug">
        ...
        <button
          ...
          className="mt-4 px-6 py-2 rounded-md border border-gray-400 text-gray-300 font-normal uppercase text-xs tracking-wide"
        >
          Start now
        </button>
      </header>
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 items-center">
        <div className="bg-[#1A1A1D] border border-[#57595B]/20 rounded-xl p-3 sm:p-4 h-60 sm:h-72 md:h-80 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] flex flex-col">
    ...
    <footer className="absolute bottom-0 left-0 w-full text-center text-[#C9CDCF] text-[10px] sm:text-xs tracking-wide opacity-70 py-2 z-10">
